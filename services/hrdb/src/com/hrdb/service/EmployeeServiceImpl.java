...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Employee> findAssociatedEmployeesForManagerid(int eid, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Page<Vacation> findAssociatedVacations(int eid, Pageable pageable) {
