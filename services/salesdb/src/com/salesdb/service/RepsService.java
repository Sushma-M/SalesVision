...
public interface RepsService {
    ...
    /*
     * Returns associate reps for given Reps id.
     *
     * @param id id value
     * @return Associate Tasks instances.
     */
    Page<Tasks> findAssociatedTaskses(int id, Pageable pageable);

    /*
     * Returns associate reps for given Reps id.
     *
     * @param id id value
     * @return Associate Quotes instances.
     */
    Page<Quotes> findAssociatedQuoteses(int id, Pageable pageable);
